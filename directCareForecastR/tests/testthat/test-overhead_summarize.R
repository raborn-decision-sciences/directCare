...
test_that("summarize_overhead_monthly returns correct structure", {
  ...
  expected_cols <- c("practice_id", "year", "month",
                     "total_overhead", "gross_overhead", "total_refunds")
...
test_that("summarize_overhead_monthly handles refunds correctly", {
  ...
  refund_row <- tibble::tibble(
    ...
    full_account_name = "Expenses:Rent", account_name = "Rent",
    description = "Deposit refund", amount = -100,
    month = 1L, year = 2025L, category = "rent",
...
test_that("summarize_overhead_weekly handles refunds correctly", {
  ...
  refund_row <- tibble::tibble(
    ...
    full_account_name = "Expenses:Rent", account_name = "Rent",
    description = "Deposit refund", amount = -50,
    month = 1L, year = 2025L, category = "rent",
    source = "gnucash_csv", is_refund = TRUE
  )
  overhead <- dplyr::bind_rows(overhead, refund_row)
